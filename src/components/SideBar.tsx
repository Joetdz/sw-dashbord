...
const useStyles = createStyles((theme) => ({
  ...
  link: {
    ...
    "&:hover": {
      backgroundColor:
        theme.colorScheme === "dark" ? theme.colors.dark[6] : "#0dda6b",
      color: theme.colorScheme === "dark" ? "#0dda6b" : theme.white,
...
export function NavbarSimple() {
  ...
  return (
    <Navbar
      ...
      width={{ sm: 300 }}
      p="md"
      sx={{ background: "#8e2cff", position: "fixed", color: "#FFFFFF" }}
    >
      <Navbar.Section grow>
